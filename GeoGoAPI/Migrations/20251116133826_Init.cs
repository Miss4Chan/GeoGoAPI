...
namespace GeoGoAPI.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        {
            migrationBuilder.DropTable(name: "CategoryWeights");

            migrationBuilder.DropTable(name: "InteractionEvents");

            migrationBuilder.DropTable(name: "PlaceLikes");

            migrationBuilder.DropTable(name: "VirtualObjects");

            migrationBuilder.DropTable(name: "UserTwins");

            migrationBuilder.DropTable(name: "VirtualPlaces");
